  ...
  return (0, _createClass2["default"])(AWSSignersV4, [{
    ...
    value: function canonicalString() {
      ...
      if (this.serviceName !== 's3') {
        ...
        pathname = (0, _map["default"])(_context = pathname.split('/')).call(_context, uriEscape).join('/');
      }
    ...
    value: function canonicalHeaders() {
      var _context2,
        _this = this;
      var headers = [];
      (0, _forEach["default"])(_context2 = (0, _keys["default"])(this.request.headers)).call(_context2, function (key) {
        headers.push([key, _this.request.headers[key]]);
      });
      (0, _sort["default"])(headers).call(headers, function (a, b) {
        return a[0].toLowerCase() < b[0].toLowerCase() ? -1 : 1;
      });
      var parts = [];
      (0, _forEach["default"])(headers).call(headers, function (item) {
    ...
    value: function signedHeaders() {
      var _context3,
        _this2 = this;
      var keys = [];
      (0, _forEach["default"])(_context3 = (0, _keys["default"])(this.request.headers)).call(_context3, function (key) {
        key = key.toLowerCase();
        if (_this2.isSignableHeader(key)) keys.push(key);
      });
      return (0, _sort["default"])(keys).call(keys).join(';');
    }
  }, {
    ...
    value: function isSignableHeader(key) {
      ...
      if ((0, _indexOf["default"])(_context4 = key.toLowerCase()).call(_context4, 'x-amz-') === 0) return true;
      return (0, _indexOf["default"])(_context5 = this.unsignableHeaders).call(_context5, key) < 0;
    }
  }, {
    key: "isPresigned",
