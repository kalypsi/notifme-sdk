  ...
  return (0, _createClass2["default"])(WhatsappInfobipProvider, [{
    ...
    value: function () {
      var _send = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee(request) {
        var _ref2, from, to, type, messageId, text, mediaUrl, templateName, templateData, rest, payload, endpoint, response, responseBody, _ref3, _ref4, message, error, _message, _t;
        return _regenerator["default"].wrap(function (_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              endpoint = (0, _security.assertSafeUrl)("".concat(this.baseUrl, "/whatsapp/1/message/").concat(type), 'WhatsApp provider');
              _context.next = 4;
