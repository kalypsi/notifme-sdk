  ...
  return (0, _createClass2["default"])(EmailMandrillProvider, [{
    ...
    value: function () {
      var _send = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee(request) {
        var _context;
        var _ref, id, userId, from, replyTo, subject, html, text, headers, to, cc, bcc, attachments, response, responseBody, _context2, _context4, message, _t;
        return _regenerator["default"].wrap(function (_context5) {
          while (1) switch (_context5.prev = _context5.next) {
              ...
              return (0, _request["default"])('https://mandrillapp.com/api/1.0/messages/send.json', {
                ...
                body: (0, _stringify["default"])({
                  ...
                  message: _objectSpread(_objectSpread({
                    from_email: from,
                    to: (0, _concat["default"])(_context = [{
                      email: to,
                      type: 'to'
                    }]).call(_context, (0, _toConsumableArray2["default"])(cc && cc.length ? (0, _map["default"])(cc).call(cc, function (email) {
                      return {
                        email: email,
                        type: 'cc'
                      };
                    }) : []), (0, _toConsumableArray2["default"])(bcc && bcc.length ? (0, _map["default"])(bcc).call(bcc, function (email) {
                      return {
                        email: email,
                        type: 'bcc'
                      };
            ...
            case 5:
              ...
              return _context5.abrupt("return", responseBody[0]._id);
            case 6:
              message = (0, _map["default"])(_context2 = (0, _keys["default"])(responseBody)).call(_context2, function (key) {
                var _context3;
                return (0, _concat["default"])(_context3 = "".concat(key, ": ")).call(_context3, responseBody[key]);
              }).join(', ');
