  ...
  return (0, _createClass2["default"])(EmailMailgunProvider, [{
    ...
    value: function () {
      var _send = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee(request) {
        var _ref, id, userId, from, replyTo, subject, html, text, headers, to, cc, bcc, attachments, form, endpoint, response, responseBody, _t;
        return _regenerator["default"].wrap(function (_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              endpoint = (0, _security.assertSafeUrl)("https://".concat(this.host, "/").concat(this.version, "/").concat(this.domainName, "/messages"), 'Mailgun API');
              _context.next = 4;
