...
var Sender = exports["default"] = /*#__PURE__*/function () {
  function Sender(channels, providers, strategies, hooks) {
    var _context,
      _this = this;
  ...
  return (0, _createClass2["default"])(Sender, [{
    ...
    value: function () {
      var _send = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee2(request) {
        var modifiedRequest, resultsByChannel, result;
        return _regenerator["default"].wrap(function (_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 1;
              return this.hooks.beforeSend(request);
            case 1:
              modifiedRequest = _context3.sent;
            case 2:
              _context3.next = 3;
              return this.sendOnEachChannel(modifiedRequest);
            case 3:
              ...
              _context3.next = 4;
              return this.hooks.afterSend(result);
            case 4:
