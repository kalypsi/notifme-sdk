...
var NotifmeSdk = exports["default"] = /*#__PURE__*/function () {
  function NotifmeSdk(options) {
    ...
    this.sender = new _sender["default"]((0, _dedupe["default"])((0, _concat["default"])(_context = []).call(_context, (0, _toConsumableArray2["default"])((0, _keys["default"])(CHANNELS)), (0, _toConsumableArray2["default"])((0, _keys["default"])(providers)))), providers, strategies, mergedOptions.hooks);
  }
